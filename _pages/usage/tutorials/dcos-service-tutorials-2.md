...
<div class="container-pod container-pod-short-top flush-bottom">
  <div class="row flex-box flex-box-fit-height flex-box-wrap row-grid">
    <article id="post-580" class="cf column-small-6 post-topic" role="article" itemscope itemtype="http://schema.org/BlogPosting"> <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/marathon-add-user/"> Adding a Marathon User Instance </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/crate/"> Deploying Crate as a DCOS Service </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/running-a-spark-job/"> Running a Spark Job </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/running-more-than-one-instance-of-cassandra/"> Running multiple Cassandra instances </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/creating-a-chronos-job/"> Creating a Chronos job </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/adding-kafka-broker/"> Adding a Kafka broker </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/show-active-services/"> Show Active Services </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/using-spark/"> Customizing Your Spark Installation </a>
    </h4>
    ...
    <h4 class="flush-top">
      <a href="/usage/managing-services/service-tutorials/install-service-with-a-custom-options-file/"> Customizing a DCOS Service </a>
    </h4>

...
*   You can now use the DCOS Networking tab in the DCOS web interface to view aggregated metrics for Virtual IPs. You can monitor VIP performance metrics across DCOS cluster. For more information, see the [documentation][5].

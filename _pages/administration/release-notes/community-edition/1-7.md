...
*   **Persistent local volumes** With Docker, the containerPath must be relative and will always appear in `/mnt/mesos/sandbox/`. If your application (e.g. a DB) needs an absolute directory this won’t work. [CORE-274][9]
    
    *   Volume cleanup [MESOS-2408][10]
    *   If you go above your quota, your task will be killed and that task can never recover. See [INFINITY-86][11]

*   **External/network volumes** No RO access from multiple tasks [emccode/dvdcli/issues/15][12]

*   **Authorization** - In this release we have perimeter security & auth, but not internal auth. Requests originating in the cluster - i.e. that don’t have an auth token issued by AdminRouter - are not subject to authorization. Example: Marathon-LB running on DCOS will work as expected against a Marathon with Security Plugin enabled: It will see all apps despite not having authentication credentials. See [MARATHON-840][13]
...
See additional known issues at <a href="https://support.mesosphere.com" target="_blank">support.mesosphere.com</a>.
 ...
 [8]: /concepts/installing/installing-enterprise-edition/manual-installation/
 [9]: https://mesosphere.atlassian.net/browse/CORE-274
 [10]: https://issues.apache.org/jira/browse/MESOS-2408
 [11]: https://mesosphere.atlassian.net/browse/INFINITY-86
 [12]: https://github.com/emccode/dvdcli/issues/15
 [13]: https://mesosphere.atlassian.net/browse/MARATHON-840
...
Before installing <span class="caps">DCOS</span> you must prepare your cluster environment.
  ...
  * **Load balancer** _For <span class="caps">DCOS</span> <span class="caps">1.2</span> and earlier:_ A high-availability (<span class="caps">HA</span>) load balancer is used to balance these <span class="caps">TCP</span> ports on your master nodes: 80, 443, 8080, 8181, 2181, 5050
